...
- 누적합에서 구간합을 구할때 범위에 따른 계산법이 다르다!

### 설계 : 10분

- 누적합 배열을 생성한 다음, 누적합 배열을 통해 구간합을 구한다.

<img width="480" alt="image" src="https://github.com/user-attachments/assets/28f8c2ba-1826-4b73-ba56-0b9aca7a9011" />